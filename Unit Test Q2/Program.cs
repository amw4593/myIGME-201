...
namespace WordSort
{
    class Program
    {
        ...
        start:
            ...
            foreach (string sThisWord in sWord)
            {
                ...
                catch
                {
                    ...
                    Console.WriteLine($"Word #{nUnsortedLength} is not a valid word.");
        ...
        static void RemoveUnsortedValue(double removeValue, ref double[] array)
        {
            ...
            foreach (double srcWord in array)
            {
